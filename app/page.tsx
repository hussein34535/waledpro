...
export default function Page() {
  ...
  return (
    <main style={{ background: C.bg, color: C.text, fontFamily: "'Cairo',-apple-system,sans-serif", WebkitFontSmoothing: "antialiased" }}>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
          ...
          .btn-android, .btn-windows, .btn-secondary {
            padding: 10px 16px !important; font-size: 13px !important; border-radius: 12px !important;
          }
          .features-grid { grid-template-columns: repeat(2, 1fr) !important; gap: 10px !important; }
          .platforms-grid { grid-template-columns: 1fr !important; gap: 16px !important; }
      ...
      {/* ═══════════════ HERO ═══════════════ */}
      <section className="hero-section" style={{ textAlign: "center", padding: "clamp(64px,10vw,112px) 24px clamp(48px,6vw,72px)", maxWidth: 820, margin: "0 auto" }}>
      ...
      {/* ═══════════════ PLATFORMS ═══════════════ */}
      <section id="platforms" className="section-padding" style={{ borderTop: `1px solid ${C.border}`, padding: "80px clamp(16px,5vw,24px)" }}>
      ...
      {/* ═══════════════ FEATURES ═══════════════ */}
      <section id="features" className="section-padding" style={{ borderTop: `1px solid ${C.border}`, padding: "80px clamp(16px,5vw,24px)" }}>
      ...
      {/* ═══════════════ FAQ ═══════════════ */}
      <section id="faq" className="section-padding" style={{ borderTop: `1px solid ${C.border}`, padding: "80px clamp(16px,5vw,24px)" }}>
      ...
      {/* ═══════════════ FINAL CTA ═══════════════ */}
      <section className="section-padding" style={{ borderTop: `1px solid ${C.border}`, padding: "80px clamp(16px,5vw,24px)", textAlign: "center" }}>
